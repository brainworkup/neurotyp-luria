# Neurotyp Luria — Neuropsychological Report Template

A [Quarto](https://quarto.org/) extension that renders professional luria neuropsychological evaluation reports using [Typst](https://typst.app/). Part of the broader **Neurotyp** ecosystem maintained by [brainworkup](https://brainworkup.org/).

**Version:** 0.1.0 | **Requires:** Quarto ≥ 1.4.0 | **License:** MIT

---

## Overview

`neurotyp-luria` provides a modular Quarto template for generating polished, clinic-ready neuropsychological reports for Luria LLM templated patients. Reports are typeset via Typst and can include:
